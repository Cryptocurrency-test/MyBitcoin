...
$ curl -X POST --header 'Content-Type: application/json' --header 'password: t t t t t' 'http://localhost:3001/operator/wallets/5dfa48528ddcf0e99fe77dc6f664228094ec1479ce6e768dd16bfb9232311f1d/addresses'
